...
export default function PlanScreen() {
  ...
  const best = nearbyParkings[0] ?? PARKINGS[0];
      ...
      >
        <div
          style={{
            ...
            height: 56,
            borderRadius: "50%",
            border: `4px solid ${COLORS.blueSoft}`,
    ...
    <div className="mesh-bg fade-in ea-screen-container">
      <div style={{ maxWidth: 840, margin: "0 auto" }}>
        ...
        >
            ...
            <div>
              ...
              <div className="ea-pills-container">
                ...
                >
                  ...
                  />{" "}
                  {best.availability}% disponible
                </span>
                <span style={pillStyle}>
                  <DollarSign size={13} /> {money(best.price)} / hora
                </span>
                <span style={pillStyle}>
                  <MapPin size={13} /> {best.distance} m
                </span>
                <span style={pillStyle}>
                  <Footprints size={13} /> {best.walk} min caminando
                </span>
                <span style={pillStyle}>
                  {best.scheduleLabel} {best.openingTime} - {best.closingTime}
                </span>
              </div>
              <div
                style={{
          ...
          >
            <GhostButton onClick={onGoMap} style={{ flex: 1, minWidth: 150 }}>
          ...
          <Card style={{ padding: 28 }}>
            ...
            >
              ...
              >
                ...
                <b style={{ color: COLORS.navy }}>~46 espacios libres</b> a la
                hora seleccionada ({displayHora}).
              </p>
            </div>
          </Card>
        </div>
