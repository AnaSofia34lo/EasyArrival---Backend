...
function Row(props: Readonly<RowProps>) {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontSize: 13.5, color: COLORS.textMuted, fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>{label}</span>
      <span style={{ fontSize: 14, color: valueColor || COLORS.text, fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>{value}</span>
    </div>
  );
}
  ...
  return (
    <div className="mesh-bg fade-in ea-screen-container">
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        {/* AI Insight Box */}
        <div className="ea-insight-box" style={{
          padding: "20px 24px", 
          borderRadius: 20, 
          ...
          <p style={{ margin: 0, fontFamily: "'Inter', sans-serif", fontSize: 14.5, color: COLORS.text, lineHeight: 1.5 }}>
            Según tu preferencia de <span style={{ color: COLORS.purple, fontWeight: 700 }}>{prefLabel}</span>, 
            el asistente virtual recomienda dirigirse a <b style={{ color: COLORS.navy }}>{bestName}</b>. Su combinación de disponibilidad prevista y tarifa se ajusta a tu perfil.
          </p>
        </div>
